...
# === НАСТРОЙКИ ===
API_TOKEN = '7816168369:AAFp-32OKO2lzteTwyf8neaTriO09Gagn1Q'
ADMIN_ID = 517235
...
async def telegram_handler(msg: types.Message):
    ...
    if slot_type == "Основной":
        await msg.answer("Вы зарегистрированы в основную сетку.
...
После перевода пришлите фото или скриншот чека сюда.", parse_mode="Markdown")
    else:
